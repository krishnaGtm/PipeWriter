...
namespace PipeWriter
{
    ...
    public class DxfFile
    {
        ...
        /// </returns>
        public static bool MergeDXF(string originalDXFFileNamne, string originalFileLocation, string destinationFileName, string destinationFileLocation, double originalStartX, double originalStartY, double originalEndX, double originalEndY, List<MergeContent> addedContents)
        {
            try
            {
